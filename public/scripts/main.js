...
exports.default = function () {
    ...
    var state = null,
        uri = (0, _getURI2.default)();

    return _states2.default.id[uri[1]];
};
...
var _getURI = require('./getURI');

var _getURI2 = _interopRequireDefault(_getURI);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

},{"../states":360,"./getURI":299}],299:[function(require,module,exports){
"use strict";
...
exports.default = function (callback, delay) {
    ...
    $r(document).on('scroll', function (e) {
        e.preventDefault();

        if (Ruddy.scroll.bool) {
            bool = true;
            event = e;
        }
    });
    ...
    function setRequest() {
        ...
        if (time - start >= delay || 166.6667) {
            if (bool && Ruddy.scroll.bool) {
                callback(event, pageYOffset);
                bool = false;
            }
            start = Date.now();
        }
        window.requestAnimationFrame(setRequest);
    }
...
exports.default = function (state, options) {
    ...
    var options = options || {},
        ...
        uri = _states2.default.uri[state],
        uriID = (0, _getURI2.default)()[2] || false;

    if ((0, _getState2.default)() == state && id == uriID) return false;

    pushState(options.title || window.titles[uri == '' ? 'home' : uri], '/' + uri + id);
...
function pushState(title, url, response) {
    if (!url) throw new TypeError('Url is not valid.');
...
},{"../states":360,"./getState":298,"./getURI":299}],302:[function(require,module,exports){
"use strict";
...
exports.default = function (callback, delay, state) {
    "use strict";
    ...
    function setRequest() {
        ...
        if (time - start >= delay) {
            if (state == (0, _getState2.default)()) callback();
            window.cancelAnimationFrame(setRequest);
            return false;
        }
        window.requestAnimationFrame(setRequest);
    }
...
},{"./getState":298}],303:[function(require,module,exports){
'use strict';
...
var _getState = require('../../actions/getState');

var _getState2 = _interopRequireDefault(_getState);

var _hide = require('./actions/hide');
...
exports.default = {
    ...
    run: function run() {
        ...
        var state = (0, _getState2.default)();
        switch (state) {
            case 0:
                (0, _hide2.default)(about, 0);
                break;

            case 1:
                (0, _display2.default)(about, 1);
                break;

            default:
                (0, _hide2.default)(about, state);
                break;
        }
    }
};

},{"../../actions/getState":298,"./actions/display":304,"./actions/hide":305}],304:[function(require,module,exports){
'use strict';
...
exports.default = function (about, state, callback) {
    "use strict";

    callback = callback || function () {};
    about.el.className = 'hide';
    about.el.className = 'show';

    Ruddy.setTimeout(function () {
        callback();
    }, 400, state);
};
...
exports.default = function (blur, state, callback) {
    "use strict";

    callback = callback || function () {};
    blur.el.className = 'blur hide';
    blur.el.className = 'blur show';
...
exports.default = {
    ...
    run: function run() {
        ...
        switch (state) {
            case 4:
                (0, _hide2.default)(blur, 4);
                $r('#thank-you').el.className = 'animate';
                break;

            default:
                (0, _display2.default)(blur, state);
                break;
        }
    }
};

},{"../../actions/getState":298,"./actions/display":306,"./actions/hide":307}],309:[function(require,module,exports){
'use strict';
...
var _setState = require('../../actions/setState');

var _setState2 = _interopRequireDefault(_setState);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var cards = $r('#portfolio .card');
...
exports.default = {
    ...
    onclick: function onclick(callback) {
        ...
        cards.each(function (card) {
            var title = $r(card).find('.info .basic .title a');

            title.on('click', function (e) {
                e.preventDefault();
                Ruddy.states.last = (0, _getState2.default)();
                callback(title);
                return false;
            });
        });
...
},{"../../actions/getState":298,"../../actions/setState":301}],310:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
    value: true
});
var contact = $r('#contact form');

exports.default = {
    el: contact,
    run: function run(frames, loader) {
        "use strict";

        contact.on('submit', function (e) {
            e.preventDefault();

            var name = contact.find('input[name="name"]').el.value,
                email = contact.find('input[name="email"]').el.value,
                message = contact.find('textarea[name="message"]').el.value;

            loader.display(loader.el);
            $r({ url: 'http://www.gilnimer.com/api/send' }).ajax({
                method: 'POST',
                data: 'token=' + window.token + '&name=' + name + '&email=' + email + '&message=' + message,
                success: function success(req, res) {
                    frames.popup('#response', {
                        type: 'success',
                        header: 'Success',
                        body: ['Thank you, your message has been sent successfully.', 'I will respond as soon as I receive the message.']
                    });

                    name = '';
                    email = '';
                    message = '';
                    loader.hide(loader.el);
                },
                error: function error(req, res) {
                    ...
                    frames.popup('#response', {
                        ...
                        body: ['Sorry, an issue has occurred while sending the message.', 'Status: ' + (res.responseCode || 543), 'Error body: ' + (res.response || '')]
                    });
...
exports.default = function (scrollCtrl, scrollBtn, header, about, showcase, footer, space, condition) {
    "use strict";
    ...
    switch (state) {
        case 0:
            (0, _setState2.default)(0);
            break;

        case 1:
            (0, _goHome2.default)(scrollCtrl, scrollBtn, header, about, showcase, footer);
            (0, _setState2.default)(0);

            menu.find('a[href]').each(function (t) {
                t.className = 'off';
            });
            menu.find('a[href="/"]').el.className = 'on';
            break;

        case 2:
            (0, _goAbout2.default)(scrollCtrl, header, about, showcase, footer);
            Ruddy.setTimeout(function () {
                (0, _scroll2.default)(_states2.default.elements[1], 1);
            }, 800, 1);
            (0, _setState2.default)(1);
            break;

        case 4:
            if (_states2.default.uri[3]) {
                if (condition) (0, _scroll2.default)(_states2.default.elements[3], 3, space);

                (0, _setState2.default)(3);
            }

            menu.find('a[href]').each(function (t) {
                t.className = 'off';
            });
            menu.find('a[href="/portfolio"]').el.className = 'on';
            break;

        default:
            if (_states2.default.uri[state - 1]) {
                if (condition) (0, _scroll2.default)(_states2.default.elements[state - 1], state - 1, space);

                (0, _setState2.default)(state - 1);
            }
            break;
    }
};
...
var _goHome = require('./goHome');

var _goHome2 = _interopRequireDefault(_goHome);

var _goAbout = require('./goAbout');

var _goAbout2 = _interopRequireDefault(_goAbout);
...
},{"../../../actions/getState":298,"../../../actions/setState":301,"../../../states":360,"./goAbout":312,"./goHome":313,"./scroll":317}],312:[function(require,module,exports){
"use strict";
...
exports.default = function (scrollCtrl, header, about, showcase, footer) {
    "use strict";

    //document.body.className = 'pauseAnimation';

    header.halfCollapse(header.el, 1, function () {
        about.display(about.el);
        document.body.style.overflow = 'visible';
    });
    scrollCtrl.hide(scrollCtrl.el, 1);
    showcase.display(showcase.el, 1);
    footer.display(footer.el, 1);
};
...
exports.default = function (scrollCtrl, scrollBtn, header, about, showcase, footer) {
    "use strict";

    document.body.style.overflow = 'hidden';
    showcase.hide(showcase.el, 0);
    footer.remove(footer.el, 0);
    scrollCtrl.display(scrollCtrl.el);
    about.hide(about.el, 0, function () {
        //document.body.className = '';
        scrollBtn.turn(scrollBtn.el, 'next');
    });

    header.expand(header.el, 0);
};
...
exports.default = function (scrollCtrl, header, about, showcase, footer, state) {
    "use strict";

    document.body.style.overflow = 'visible';
    header.collapse(header.el, state);
    about.hide(about.el, state);
    scrollCtrl.hide(scrollCtrl.el, state);
    showcase.display(showcase.el, state);
    footer.display(footer.el, state);
};
...
exports.default = function (scrollCtrl, scrollBtn, header, about, showcase, footer, blur, space, condition) {
    "use strict";
    ...
    switch (state) {
        ...
        case 1:
            (0, _goLab2.default)(scrollCtrl, header, about, showcase, footer, 2);
            (0, _scroll2.default)(_states2.default.elements[2], 2, space);
            (0, _setState2.default)(2);
            break;
        ...
        case 3:
            if (_states2.default.uri[4]) {
                if (condition) (0, _scroll2.default)(_states2.default.elements[state + 1], state + 1, space);

                if ($r('#thank-you').el.className != 'aniamte') {
                    blur.hide(blur.el, 4);
                    $r('#thank-you').el.className = 'animate';
                }
                menu.find('a[href]').each(function (t) {
                ...
                menu.find('a[href="/contact"]').el.className = 'on';
                (0, _setState2.default)(4);
            }
            break;
...
var _goLab = require('./goLab');

var _goLab2 = _interopRequireDefault(_goLab);
...
},{"../../../actions/getState":298,"../../../actions/setState":301,"../../../states":360,"./goAbout":312,"./goHome":313,"./goLab":314,"./scroll":317}],316:[function(require,module,exports){
'use strict';
...
exports.default = function (event, pageY, actions, scrollCtrl, scrollBtn, header, about, showcase, lab, portfolio, footer, blur, space) {
    var scrollY = pageY(),
        condition = $doc(document).viewport('width') > 716,
        postions = [header.el.position('y'), lab.position('y'), portfolio.position('y'), footer.el.position('y')];

    if ((0, _getState2.default)() == 0) return;

    if (Math.abs(Ruddy.scroll.y - scrollY) <= Ruddy.scroll.delta) return;

    if (scrollY > Ruddy.scroll.y) {
        Ruddy.scroll.direction = 'next';
        scrollBtn.turn(scrollBtn.el, 'next');

        if (scrollY >= postions[1] - space && scrollY < postions[2] - space) {
            if ((0, _getState2.default)() != 2) actions.next(scrollCtrl, scrollBtn, header, about, showcase, footer, blur, space, condition);
        } else if (scrollY >= postions[2] - space && scrollY < postions[3] - space) {
            if ((0, _getState2.default)() != 3) actions.next(scrollCtrl, scrollBtn, header, about, showcase, footer, blur, space, condition);
        }

        if (scrollY >= postions[3] - space || scrollY + $doc(document).viewport('height') >= $doc(document).size('height') - 40) {
            if ((0, _getState2.default)() != 4) actions.next(scrollCtrl, scrollBtn, header, about, showcase, footer, blur, space, condition);
        }
    } else {
        Ruddy.scroll.direction = 'back';
        scrollBtn.turn(scrollBtn.el, 'back');

        if ((0, _getState2.default)() == 1 || (0, _getState2.default)() == 2) return;

        if (scrollY >= postions[1] - lab.size('height') * 0.4 && scrollY < postions[2] - portfolio.size('height') * 0.4) {
            if ((0, _getState2.default)() != 2) actions.back(scrollCtrl, scrollBtn, header, about, showcase, footer, space, condition);
        } else if (scrollY >= postions[2] - portfolio.size('height') * 0.4 && scrollY < postions[3] - footer.el.size('height') * 0.4) {
            if ((0, _getState2.default)() != 3) actions.back(scrollCtrl, scrollBtn, header, about, showcase, footer, space, condition);
        }
    }
    Ruddy.scroll.y = scrollY;
};
...
},{"../../../actions/getState":298}],317:[function(require,module,exports){
'use strict';
...
exports.default = function (el, state, gap) {
    "use strict";

    var posY = $r(el).position('y');
    gap = gap || 0;

    Ruddy.scroll.bool = false;
    $r(document).scrollY(posY - gap, {
        duration: 0.6,
        callback: function callback() {
            Ruddy.scroll.bool = true;
        }
    });
};
...
},{"../../../actions/getState":298}],318:[function(require,module,exports){
'use strict';
...
},{"../../../actions/getState":298,"../../../actions/setState":301}],319:[function(require,module,exports){
'use strict';
...
var _goHome = require('./actions/goHome');

var _goHome2 = _interopRequireDefault(_goHome);

var _goAbout = require('./actions/goAbout');

var _goAbout2 = _interopRequireDefault(_goAbout);

var _goLab = require('./actions/goLab');

var _goLab2 = _interopRequireDefault(_goLab);

var _back = require('./actions/back');
...
var _scroll = require('./actions/scroll');

var _scroll2 = _interopRequireDefault(_scroll);

var _onscroll = require('./actions/onscroll');

var _onscroll2 = _interopRequireDefault(_onscroll);

var _transform = require('./actions/transform');
...
exports.default = {
    ...
    goAbout: _goAbout2.default,
    goLab: _goLab2.default,
    back: _back2.default,
    next: _next2.default,
    scroll: _scroll2.default,
    onscroll: _onscroll2.default,
    ...
    run: function run(callback) {
        ...
        window.onload = function () {
            callback({
                ...
                onscroll: _onscroll2.default,
                transform: _transform2.default,
                init: function init(state, gap) {
                    if (state > 0 && state < 10) {
                        (0, _scroll2.default)(_states2.default.elements[state], state, gap);
                    }
                }
            });
        };
...
},{"../../actions/getState":298,"../../states":360,"./actions/back":311,"./actions/goAbout":312,"./actions/goHome":313,"./actions/goLab":314,"./actions/next":315,"./actions/onscroll":316,"./actions/scroll":317,"./actions/transform":318}],320:[function(require,module,exports){
'use strict';
...
exports.default = function (footer, state, callback) {
    "use strict";

    callback = callback || function () {};
    footer.el.className = 'hide';
    footer.el.className = 'show';
...
exports.default = {
    ...
    run: function run() {
        ...
        switch (state) {
            case 0:
                (0, _remove2.default)(footer, 0);
                break;

            default:
                (0, _display2.default)(footer, state);
                break;
        }
    }
};

},{"../../actions/getState":298,"./actions/display":320,"./actions/hide":321,"./actions/remove":322}],324:[function(require,module,exports){
"use strict";
...
exports.default = function (frame, state, callback) {
    "use strict";

    callback = callback || function () {};

    frame.el.className = 'frame hide';
    frame.el.className = 'frame show';
...
exports.default = function (frame) {
    ...
    window.setTimeout(function () {
        frame.el.className = 'frame remove';
    }, 400);
};
...
exports.default = {
    ...
    popup: function popup(frameID, data) {
        "use strict";

        var frame = $r(frameID),
            header = frame.find('.frame-header'),
            body = frame.find('.frame-body');

        header.el.className = 'frame-header ' + data.type;
        header.find('h2').html(data.header).inner();

        body.html(' ').inner();
        $arr(data.body).forEach(function (v) {
            body.html('<p>' + v + '</p>').append();
        });

        (0, _display2.default)($r(frameID));
    },
    onclick: function onclick() {
        "use strict";

        frames.each(function (v) {
            var frame = $r(v),
                exitBtn = frame.find('.exit-button a i');

            frame.on('click', function (e, t) {
                e.preventDefault();
                if (t == frame.el || t == exitBtn.el) {
                    (0, _hide2.default)(frame);
                }
            });
        });
    }
...
},{"./actions/create":324,"./actions/display":325,"./actions/hide":326,"./actions/remove":327}],329:[function(require,module,exports){
'use strict';
...
exports.default = function (header, state, callback) {
    "use strict";
    ...
    header.el.className = 'wrapper collapse';
    main.el.className = 'main remove';
...
exports.default = function (header, state, callback) {
    ...
    callback = callback || function () {};
    header.el.className = 'wrapper expand';

    Ruddy.setTimeout(function () {
        main.el.className = 'main hide';
        main.el.className = 'main show';
        callback();
    }, 400, state);
};
...
exports.default = function (header, state, callback) {
    ...
    callback = callback || function () {};
    header.el.className = 'wrapper half-collapse';
    main.el.className = 'main hide';
...
exports.default = function (header, state, callback) {
    ...
    header.style('height', height * 0.76 + 'px');
...
var _start = require('./actions/start');

var _start2 = _interopRequireDefault(_start);

var _halfCollapse = require('./actions/half-collapse');

var _halfCollapse2 = _interopRequireDefault(_halfCollapse);

var _collapse = require('./actions/collapse');

var _collapse2 = _interopRequireDefault(_collapse);

var _expand = require('./actions/expand');

var _expand2 = _interopRequireDefault(_expand);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var header = $r('header.wrapper');

exports.default = {
    el: header,
    start: _start2.default,
    halfCollapse: _halfCollapse2.default,
    ...
    run: function run() {
        ...
        switch (state) {
            case 0:
                (0, _start2.default)(header, 0);
                break;

            case 1:
                (0, _halfCollapse2.default)(header, 1);
                break;

            default:
                (0, _collapse2.default)(header, function () {});
                break;
        }
    }
};

},{"../../actions/getState":298,"../../actions/setState":301,"../../states":360,"./actions/collapse":329,"./actions/expand":330,"./actions/half-collapse":331,"./actions/start":332}],334:[function(require,module,exports){
'use strict';
...
exports.default = {
    run: function run() {
        ...
        var span = $r('#thank-you').find('span');

        $r('#contact input, #contact textarea').each(function (v) {
            $r(v).on('focus', function (e, t) {
                span.style('animation', 'none');
                span.style('opacity', '0');
            });

            if ($r(v.parentElement).find('label').el.length == 0) return;

            if (v.value != '') {
                $r(v.parentElement).find('label').style('opacity', '0');
            } else {
                $r(v.parentElement).find('label').attribute('style', ' ');
            }
        });

        $r('#contact input[name="name"]').on('blur', function () {
            span.attribute('style', ' ');
            if (this.value != '') {
                $r('#contact .input-name label').style('opacity', '0');
            } else {
                $r('#contact .input-name label').attribute('style', ' ');
            }
        });

        $r('#contact input[name="email"]').on('blur', function () {
            span.attribute('style', ' ');
            if (this.value != '') {
                $r('#contact .input-email label').style('opacity', '0');
            } else {
                $r('#contact .input-email label').attribute('style', ' ');
            }
        });

        $r('#contact textarea').on('blur', function () {
            span.attribute('style', ' ');
            if (this.value != '') {
                $r('#contact .input-message label').style('opacity', '0');
            } else {
                $r('#contact .input-message label').attribute('style', ' ');
            }
        });
    }
};
...
exports.default = {
    ...
    run: function run() {
        window.setTimeout(function () {
            ...
            (0, _hide2.default)(loader);
        }, 167);
    }
};

},{"./actions/display":335,"./actions/hide":336}],338:[function(require,module,exports){
'use strict';
...
},{"../../actions/getState":298,"../../actions/setState":301}],339:[function(require,module,exports){
'use strict';
...
var menu = $r('#menu'),
    span = menu.find('a.button span'),
    aResume = menu.find('a[href="/resume"]'),
    aPortfolio = menu.find('a[href="/portfolio"]'),
    aContact = menu.find('a[href="/contact"]');

function switchMenu() {
    "use strict";

    var className = menu.el.className || ' ';

    switch (className) {
        case 'show':
            span.html('MENU').inner();
            menu.el.className = 'hide';
            window.setTimeout(function () {
                menu.el.className = 'remove';
            }, 300);
            break;
...
exports.default = {
    el: menu,
    onclick: function onclick(resume) {
        "use strict";

        aResume.on('click', function (e) {
            e.preventDefault();
            Ruddy.states.last = (0, _getState2.default)();
            resume.display(resume.el, 9);
            (0, _setState2.default)(9);
        });
    },
    run: function run() {
        "use strict";
        ...
        switch (state) {
            case 0:
                $r('#menu nav a[href="/"]').el.className = 'on';
                break;

            case 3:
                aPortfolio.el.className = 'on';
                break;

            case 4:
                aContact.el.className = 'on';
                break;
        }

        _menuButton2.default.onclick(function (e, t) {
            e.preventDefault();
            switchMenu();
        });
    }
...
},{"../../actions/getState":298,"../../actions/setState":301,"../../states":360,"../menu-button/menu-button":338}],340:[function(require,module,exports){
'use strict';
...
exports.default = function (project, id, clientID, callback, error) {
    "use strict";

    $r({ url: 'https://www.behance.net/v2/projects/' + id + '?client_id=' + clientID + '&callback=callback' }).jsonp({
        success: function success(data, script) {
            data = data.project;

            var elements = {
                profile: project.find('.profile-picture').find('img'),
                title: project.find('h2.title'),
                name: project.find('div.title a'),
                modules: project.find('#project-canvas'),
                fields: project.find('.fields'),
                desc: project.find('.description'),
                likes: project.find('.likes'),
                views: project.find('.views')
            },
                fields = '';

            elements.modules.html(' ').inner();
            elements.profile.attribute('src', data.owners[0]['images'][100]);
            elements.title.html(data.name).inner();
            elements.name.html(data.name).inner();
            elements.name.attribute('href', data.url);
            elements.likes.html(data.stats.appreciations).inner();
            elements.views.html(data.stats.views).inner();
            elements.desc.html(data.description).inner();

            $arr(data.fields).forEach(function (v, i) {
                fields += field(v);
                if (i != data.fields.length - 1) fields += ", ";
            });

            elements.fields.html(fields).inner();

            $arr(data.modules).forEach(function (v, k) {
                switch (v.type) {
                    case 'image':
                        elements.modules.html(moduleImage(v['sizes'])).append();
                        break;

                    default:
                        elements.modules.html(moduleText(v['text'], v['alignment'])).append();
                        break;
                }
            });
        ...
        timeout: function timeout() {
            console.log('Oops, sorry we ran into a problem requsting this page!');
        }
    });
};

function moduleImage(images) {
    "use strict";

    return '<div class="module image">\n                <img src="' + images[1400] + '" srcset="' + images['disp'] + ' 600w, ' + images['max_1200'] + ' 1200w, ' + images[1400] + ' 1400w, ' + images['max_1920'] + ' 1400w" sizes="(max-width: 1400px) 100vw, 1400px">\n            </div>';
}

function moduleText(text, alignment) {
    "use strict";

    return '<div class="module text ' + alignment + '">' + text + '</div>';
}

function field(field) {
    "use strict";

    return '<a href="https://www.behance.net/search?field=' + field + '">' + field + '</a>';
}
...
exports.default = function (project) {
    ...
    project.el.className = 'hide';
    window.setTimeout(function () {
        project.el.className = 'show';
    }, 1);
};
...
exports.default = function (project, callback) {
    "use strict";
...
exports.default = {
    ...
    display: _display2.default,
    create: _create2.default,
    popup: function popup(id, loader) {
        "use strict";

        var client = 'kHYnWxPNRpoGLro80J4FLu2HQsMcUUU3';

        loader.display(loader.el);
        if (project.attribute('data-id') != id) {
            (0, _create2.default)(project, id, client, function (data, script) {
                document.body.style.overflow = 'hidden';
                (0, _display2.default)(project);
                loader.hide(loader.el);

                if (script) window.document.head.removeChild(script);

                (0, _setState2.default)(10, { title: data.name, id: id });
            });
            return;
        }
    ...
    onclick: function onclick() {
        ...
        project.on('click', function (e, t) {
            if (t == project.el && clicks == 0) {
                clicks++;
                (0, _hide2.default)(project, function () {
                    clicks = 0;
                });

                document.body.style.overflow = 'visible';
                (0, _setState2.default)(Ruddy.states.last);
            }
        });
    }
};

},{"../../actions/getState":298,"../../actions/setState":301,"./actions/create":340,"./actions/display":341,"./actions/hide":342,"./actions/remove":343}],345:[function(require,module,exports){
'use strict';
...
exports.default = function (resume, state, callback) {
    "use strict";

    callback = callback || function () {};

    document.body.style.overflow = 'hidden';
    resume.el.className = 'hide';
    resume.el.className = 'show';
    Ruddy.setTimeout(function () {
        callback();
    }, 300, state);
};
...
exports.default = {
    ...
    onclick: function onclick() {
        ...
        resume.on('click', function (e, t) {
            e.preventDefault();
            var state = Ruddy.states.last;

            if (t == resume.el) {
                (0, _hide2.default)(resume, state);
...
},{"../../actions/getState":298,"../../actions/setState":301,"./actions/display":345,"./actions/hide":346}],348:[function(require,module,exports){
'use strict';
...
var scrollBack = $r('#scroll-back');

exports.default = {
    el: scrollBack,
    onhover: function onhover(callback) {
        scrollBack.on('mouseover', function (e, t) {
            "use strict";
    ...
    onclick: function onclick(callback) {
        scrollBack.on('click', function (e, t) {
            "use strict";
...
},{"../../actions/getState":298,"../../actions/setState":301,"../../states":360}],349:[function(require,module,exports){
'use strict';
...
exports.default = function (scrollBtn, direction) {
    "use strict";

    scrollBtn.attribute('data-direction', direction);

    if (direction == 'next') {
        scrollBtn.find('i').el.className = iconNext;
    } else {
        scrollBtn.find('i').el.className = iconBack;
    }

    Ruddy.scroll.direction = direction;
    return direction;
};

var iconNext = 'fa fa-chevron-down',
    iconBack = 'fa fa-chevron-up';
...
var _turn = require('./actions/turn');

var _turn2 = _interopRequireDefault(_turn);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var scrollBtn = $r('#scroll-button');

exports.default = {
    el: scrollBtn,
    turn: _turn2.default,
    onclick: function onclick(callback) {
        scrollBtn.on('click', function (e, t) {
            "use strict";
...
},{"../../actions/getState":298,"../../actions/setState":301,"../../states":360,"./actions/turn":349}],351:[function(require,module,exports){
'use strict';
...
exports.default = function (scrollCtrl, state, callback) {
    "use strict";

    callback = callback || function () {};
    scrollCtrl.el.className = 'hide';
    scrollCtrl.el.className = 'show';
...
exports.default = function (scrollCtrl, state, callback) {
    ...
    callback = callback || function () {};
    scrollCtrl.el.className = 'hide';
    scrollCtrl.el.className = 'remove';
...
var scrollCtrl = $r('#scroll-controlls');
...
exports.default = {
    ...
    run: function run() {
        ...
        switch (state) {
            case 0:
                (0, _display2.default)(scrollCtrl, 0);
                break;

            default:
                (0, _hide2.default)(scrollCtrl, state);
                break;
        }
    }
};

},{"../../actions/getState":298,"../../actions/setState":301,"../../states":360,"./actions/display":351,"./actions/hide":352}],354:[function(require,module,exports){
'use strict';
...
var scrollNext = $r('#scroll-next');

exports.default = {
    el: scrollNext,
    onhover: function onhover(callback) {
        scrollNext.on('mouseover', function (e, t) {
            "use strict";
    ...
    onclick: function onclick(callback) {
        scrollNext.on('click', function (e, t) {
            "use strict";
...
},{"../../actions/getState":298,"../../actions/setState":301,"../../states":360}],355:[function(require,module,exports){
'use strict';
...
exports.default = function (showcases, state, callback) {
    "use strict";

    callback = callback || function () {};
    showcases.each(function (showcase) {
        showcase.className = 'showcase hide';
        showcase.className = 'showcase show';
        Ruddy.setTimeout(function () {
            callback();
        }, 400, state);
    });
...
exports.default = function (showcases, state, callback) {
    ...
    showcases.each(function (showcase) {
        showcase.className = 'showcase hide';
        Ruddy.setTimeout(function () {
            showcase.className = 'showcase remove';
            callback();
        }, 400, state);
    });
};
...
exports.default = function (showcases) {
    "use strict";
...
exports.default = {
    ...
    run: function run() {
        ...
        switch (state) {
            case 0:
                (0, _remove2.default)(showcase, 0);
                break;

            default:
                (0, _display2.default)(showcase, state);
                break;
        }
    }
};

},{"../../actions/getState":298,"./actions/display":355,"./actions/hide":356,"./actions/remove":357}],359:[function(require,module,exports){
'use strict';
...
var _timeOut = require('./actions/timeOut');
...
var _getURI = require('./actions/getURI');

var _getURI2 = _interopRequireDefault(_getURI);

var _document = require('./components/document/document');
...
var _showcase = require('./components/showcase/showcase');
...
var _scrollControlls = require('./components/scroll-controlls/scroll-controlls');

var _scrollControlls2 = _interopRequireDefault(_scrollControlls);

var _scrollButton = require('./components/scroll-button/scroll-button');

var _scrollButton2 = _interopRequireDefault(_scrollButton);

var _scrollNext = require('./components/scroll-next/scroll-next');

var _scrollNext2 = _interopRequireDefault(_scrollNext);

var _scrollBack = require('./components/scroll-back/scroll-back');

var _scrollBack2 = _interopRequireDefault(_scrollBack);

var _contactForm = require('./components/contact-form/contact-form');

var _contactForm2 = _interopRequireDefault(_contactForm);

var _frames = require('./components/frames/frames');

var _frames2 = _interopRequireDefault(_frames);

var _blur = require('./components/blur/blur');
...
var lab = _showcase2.default.lab;
var portfolio = _showcase2.default.portfolio;
var initState = (0, _getState2.default)();

var headerY = 88;
var space = $doc(document).viewport('width') > 716 ? headerY + 50 : headerY + 10;

Ruddy.setTimeout = _timeOut2.default;
Ruddy.states = { last: 0 };
Ruddy.scroll = { bool: true, delta: 5, y: 0, direction: 'next' };

_document2.default.run(function (actions) {
    _loader2.default.run();
    _menu2.default.run();
    _header2.default.run();
    _footer2.default.run();
    _about2.default.run();
    _showcase2.default.run();
    _scrollControlls2.default.run();
    _label2.default.run();
    _blur2.default.run();
    _resume2.default.run();
    _contactForm2.default.run(_frames2.default, _loader2.default);
    _project2.default.onclick();
    _frames2.default.onclick();
    _resume2.default.onclick();
    _menu2.default.onclick(_resume2.default);

    Ruddy.setTimeout(function () {
        "use strict";

        actions.init(initState, space);
    }, 167, initState);

    (0, _onScroll2.default)(function (event, pageY) {
        actions.onscroll(event, pageY, actions, _scrollControlls2.default, _scrollButton2.default, _header2.default, _about2.default, _showcase2.default, lab, portfolio, _footer2.default, _blur2.default, space);
    });

    if ((0, _getState2.default)() == 10) _project2.default.popup((0, _getURI2.default)()[2], _loader2.default);

    _scrollNext2.default.onhover(function () {
        _scrollButton2.default.turn(_scrollButton2.default.el, 'next');
    });

    _scrollBack2.default.onhover(function () {
        _scrollButton2.default.turn(_scrollButton2.default.el, 'back');
    });

    _scrollBack2.default.onclick(function () {
        actions.back(_scrollControlls2.default, _scrollButton2.default, _header2.default, _about2.default, _showcase2.default, _footer2.default, space, true);
    });

    _scrollNext2.default.onclick(function () {
        actions.next(_scrollControlls2.default, _scrollButton2.default, _header2.default, _about2.default, _showcase2.default, _footer2.default, _blur2.default, space, true);
    });

    _scrollButton2.default.onclick(function () {
        if (Ruddy.scroll.direction == 'next') {
            actions.next(_scrollControlls2.default, _scrollButton2.default, _header2.default, _about2.default, _showcase2.default, _footer2.default, _blur2.default, space, true);
            return;
        }
        actions.back(_scrollControlls2.default, _scrollButton2.default, _header2.default, _about2.default, _showcase2.default, _footer2.default, space, true);
    ...
    _card2.default.onclick(function (title) {
        _project2.default.popup(title.attribute('id').replace('project-', ''), _loader2.default);
    });
});

},{"./actions/getState":298,"./actions/getURI":299,"./actions/onScroll":300,"./actions/setState":301,"./actions/timeOut":302,"./components/about/about":303,"./components/blur/blur":308,"./components/card/card":309,"./components/contact-form/contact-form":310,"./components/document/document":319,"./components/footer/footer":323,"./components/frames/frames":328,"./components/header/header":333,"./components/label/label":334,"./components/loader/loader":337,"./components/menu/menu":339,"./components/project/project":344,"./components/resume/resume":347,"./components/scroll-back/scroll-back":348,"./components/scroll-button/scroll-button":350,"./components/scroll-controlls/scroll-controlls":353,"./components/scroll-next/scroll-next":354,"./components/showcase/showcase":358,"./states":360,"babel-polyfill":1}],360:[function(require,module,exports){
'use strict';
